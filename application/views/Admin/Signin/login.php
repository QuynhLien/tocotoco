...
<head>
  ...
  <title>Admin Sign in | MilkteaTEN</title>
...
<body class="hold-transition login-page" style="background: url('<?= site_url(); ?>template/images/banner7.jpg') center no-repeat; background-size: cover;" >
  <!-- <div style="height: 100%; position: absolute; width: 100%; background-color: rgb(1,1,1,0.4);"></div> -->
<div class="login-box">
  <div class="login-logo">
    <a style="color: azure" href="<?= site_url('adTpl') ?>/index2.html"><b>MilkteaTEN</b> Admin</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
